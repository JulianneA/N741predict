...
author: "Julianne Ammirati, editing code by Melinda K. Higgins, PhD."
...
---
This project utilizes data from the course textbook.
...
### Use poisson(link = "log") for count data! 
...
* For every change in the predictor, we are not changing your risk, but your odds of risk (more odds ratio, not risk itself).
...
```
 [java stat contingency table](http://statpages.info/ctab2x2.html)
...
* If false positive rate is equal to true positive rate, the line would be straight and your prediction is no better than a coin flip.
